...
{
    /// <summary>
    /// Designer layout for <see cref="Shaker.SQLLiteDB.Activities.Activities.Schema.SQLiteGetTableSchema"/>: which fields are drawn inside the
    /// activity itself, in what order, and how each one is edited. Generated - see tools/generate-viewmodels.
    /// </summary>
    public class SQLiteGetTableSchemaViewModel : DesignPropertiesViewModel
    {
        public SQLiteGetTableSchemaViewModel(IDesignServices services)
            : base(services)
        {
        }
        ...
        protected override void InitializeModel()
        {
            ...
            TableName.Tooltip = "Table whose columns should be described.";
            ...
            Result.DisplayName = "Schema";
            Result.Tooltip = "One row per column: ordinal, name, declared type, not null, default and primary key.";
