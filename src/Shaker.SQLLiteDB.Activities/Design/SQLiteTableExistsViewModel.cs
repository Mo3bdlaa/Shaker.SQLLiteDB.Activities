...
{
    /// <summary>
    /// Designer layout for <see cref="Shaker.SQLLiteDB.Activities.Activities.Schema.SQLiteTableExists"/>: which fields are drawn inside the
    /// activity itself, in what order, and how each one is edited. Generated - see tools/generate-viewmodels.
    /// </summary>
    public class SQLiteTableExistsViewModel : DesignPropertiesViewModel
    {
        public SQLiteTableExistsViewModel(IDesignServices services)
            : base(services)
        {
        }
        ...
        protected override void InitializeModel()
        {
            ...
            TableName.Tooltip = "Name of the table or view to look for.";
            ...
            Result.DisplayName = "Exists";
            Result.Tooltip = "True when the table (or view) is there.";
