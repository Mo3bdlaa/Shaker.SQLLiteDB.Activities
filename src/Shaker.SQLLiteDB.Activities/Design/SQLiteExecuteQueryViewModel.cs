...
{
    /// <summary>
    /// Designer layout for <see cref="Shaker.SQLLiteDB.Activities.Activities.Query.SQLiteExecuteQuery"/>: which fields are drawn inside the
    /// activity itself, in what order, and how each one is edited. Generated - see tools/generate-viewmodels.
    /// </summary>
    public class SQLiteExecuteQueryViewModel : DesignPropertiesViewModel
    {
        public SQLiteExecuteQueryViewModel(IDesignServices services)
            : base(services)
        {
        }
        ...
        public DesignOutArgument<System.Data.DataTable> Result { get; set; } = new DesignOutArgument<System.Data.DataTable>();
        ...
        public DesignInArgument<string> ResultTableName { get; set; } = new DesignInArgument<string>();
        ...
        public DesignOutArgument<int> RowCount { get; set; } = new DesignOutArgument<int>();
        ...
        protected override void InitializeModel()
        {
            ...
            Result.DisplayName = "Data table";
            Result.Tooltip = "The rows the query returned.";
            ...
            ParameterValues.IsVisible = false;
            ...
            MaxRows.Tooltip = "Stop reading after this many rows. 0 means no limit.";
            MaxRows.Category = "Options";
            MaxRows.IsVisible = false;
            MaxRows.OrderIndex = order++;
            MaxRows.Widget = new DefaultWidget { Type = "Input" };

            ResultTableName.DisplayName = "Result table name";
            ResultTableName.Tooltip = "Name given to the resulting DataTable.";
            ResultTableName.Category = "Options";
            ResultTableName.IsVisible = false;
            ResultTableName.OrderIndex = order++;
            ResultTableName.Widget = new DefaultWidget { Type = "Input" };
            ...
            RowCount.DisplayName = "Row count";
            RowCount.Tooltip = "Number of rows in the result.";
            RowCount.Category = "Output";
            RowCount.IsVisible = false;
            RowCount.OrderIndex = order++;
            RowCount.Widget = new DefaultWidget { Type = "Input" };
