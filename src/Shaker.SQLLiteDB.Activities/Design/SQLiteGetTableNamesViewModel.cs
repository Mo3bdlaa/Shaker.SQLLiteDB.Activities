...
{
    /// <summary>
    /// Designer layout for <see cref="Shaker.SQLLiteDB.Activities.Activities.Schema.SQLiteGetTableNames"/>: which fields are drawn inside the
    /// activity itself, in what order, and how each one is edited. Generated - see tools/generate-viewmodels.
    /// </summary>
    public class SQLiteGetTableNamesViewModel : DesignPropertiesViewModel
    {
        public SQLiteGetTableNamesViewModel(IDesignServices services)
            : base(services)
        {
        }
        ...
        public DesignOutArgument<System.Collections.Generic.List<string>> Result { get; set; } = new DesignOutArgument<System.Collections.Generic.List<string>>();
        ...
        public DesignProperty<bool> IncludeViews { get; set; } = new DesignProperty<bool>();

        public DesignProperty<bool> IncludeSystemTables { get; set; } = new DesignProperty<bool>();
        ...
        protected override void InitializeModel()
        {
            ...
            Result.DisplayName = "Table names";
            Result.Tooltip = "The names found in the database.";
            ...
            IncludeViews.DisplayName = "Include views";
            IncludeViews.Tooltip = "Also list views, not only tables.";
            IncludeViews.Category = "Options";
            IncludeViews.IsVisible = false;
            IncludeViews.OrderIndex = order++;
            IncludeViews.Widget = new DefaultWidget { Type = "Checkbox" };

            IncludeSystemTables.DisplayName = "Include internal tables";
            IncludeSystemTables.Tooltip = "Also list the internal sqlite_ tables.";
            IncludeSystemTables.Category = "Options";
            IncludeSystemTables.IsVisible = false;
            IncludeSystemTables.OrderIndex = order++;
            IncludeSystemTables.Widget = new DefaultWidget { Type = "Checkbox" };
